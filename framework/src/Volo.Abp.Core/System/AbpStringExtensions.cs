...
namespace System
{
    ...
    public static class AbpStringExtensions
    {
        ...
        /// <summary>×ª»»ÎªGuid</summary>
        public static Guid ToGuid(this string value)
        {
            return Guid.Parse(value);
        }
        /// <summary>Base64×Ö·û´®×ª»»Îª×Ö½ÚÊý×é</summary>
        public static byte[] ToBytesFromBase64String(this string content)
        {
            return Convert.FromBase64String(content);
        }
        /// <summary>×Ö½ÚÊý×é×ª»»ÎªBase64×Ö·û´®</summary>
        public static string ToBase64String(this byte[] content)
        {
            return Convert.ToBase64String(content);
        }
        /// <summary>GBK´úÂëÒ³</summary>
        public const int GBKCodePage = 936;
        /// <summary>È¡ºº×ÖÆ´ÒôµÄÊ××ÖÄ¸</summary>
        /// <param name="chineseName">ºº×Ö</param>
        ...
        public static string GetPYCapitals(this string chineseName)
        {
            ...
            while (i < gbkBytes.Length)
            {
                ...
                #region Éú³Éºº×ÖÆ´Òô¼òÂë,È¡Æ´ÒôÊ××ÖÄ¸
